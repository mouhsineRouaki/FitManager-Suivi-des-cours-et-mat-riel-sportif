...
<div id="equipModal"
  ...
  <div class="bg-white p-6 rounded-lg w-96 shadow-xl">
      ...
      <form method="POST">
          ...
          <input type="text" id="equip_nom" name="equip_nom"
                 class="w-full border p-2 rounded mb-3" placeholder="Nom" required>

          <input type="text" id="equip_type" name="equip_type"
                 class="w-full border p-2 rounded mb-3" placeholder="Type" required>

          <input type="number" id="equip_qt" name="equip_qt"
                 class="w-full border p-2 rounded mb-3" placeholder="Quantité" required>

          <select id="equip_etat" name="equip_etat"
